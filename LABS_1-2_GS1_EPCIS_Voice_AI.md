# Voice Ledger - Labs 1 & 2: Foundation & Voice AI Layer

This document contains comprehensive documentation for the foundational labs of the Voice Ledger project.

**Contents:**
- **Lab 1**: GS1 Identifiers & EPCIS Events (~1,900 lines)
  - GS1 standards (GLN, GTIN, SSCC)
  - EPCIS 2.0 event construction
  - JSON canonicalization techniques
  - SHA-256 cryptographic hashing
  
- **Lab 2**: Voice & AI Layer (~2,850 lines)
  - OpenAI Whisper integration (ASR)
  - GPT-3.5 for NLU (intent & entity extraction)
  - FastAPI service architecture
  - API authentication and security

**Total**: ~4,774 lines of detailed explanations, code examples, design decisions, and best practices.

**Source**: Extracted from BUILD_LOG.md (lines 122-4895)
